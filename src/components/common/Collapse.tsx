        ...
        >
          <div className={classCollapseItem}>
            <div
              ...
              role="button"
            >
              <h2 className="w-full pr-2 text-lg font-medium leading-6 text-primary-50 dark:text-slate-300">{title}</h2>
              {iconDown && iconUp ? (
                activeIndex === index ? (
                  iconUp
                ) : (
            ...
            {activeIndex === index && (
              ...
              >
                <p className="mt-2 text-primary-300 dark:text-slate-400">{description}</p>
              </div>
            )}
          </div>
        </div>
