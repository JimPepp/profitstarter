            ...
            <div key={id ? `item-${id}-${index}` : `item-grid-${index}`}>
              <div className={(twMerge('flex flex-row max-w-md'), panelClass)}>
                ...
                <div className="mt-0.5">
                  ...
                  {description && (
                    <p
                      className={twMerge(`text-primary-600 dark:text-slate-400 ${title ? 'mt-3' : ''}`, descriptionClass)}
                    >
                      {description}
                    </p>
                  )}
                  {callToAction && (
                    <CTA
                      ...
                      linkClass={twMerge(
                        ...
                        } text-primary font-bold hover:text-accent-600 text-accent-200/90 hover:underline cursor-pointer`,
                        actionClass,
                      )}
                    />
                  )}
